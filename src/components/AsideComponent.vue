    ...
    <div class="asideContent">
      ...
      <ul class="asideList">
        <li class="mb-lg-8">
          <router-link
            :to="{
              path: `/personalwall/${profile?._id}`,
              query: { name: profile?.name, photo: profile?.photo },
            }"
            class="asideLink"
          >
            <img
        ...
        <li class="mb-lg-8">
          <router-link to="/followlist" class="asideLink">
            <div class="asideLinkIcon">
        ...
        <li>
          <router-link to="/likelist" class="asideLink">
            <div class="asideLinkIcon">
